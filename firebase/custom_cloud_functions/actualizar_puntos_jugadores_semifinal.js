...
exports.actualizarPuntosJugadoresSemifinal = functions
  .runWith({
    memory: '128MB'
    ...
    try {
      ...
      for (const playerDoc of playersSnapshot.docs) {
        ...
        // Actualizar el campo "puntos_semifinal" en el documento del jugador
        await playerRef.update({ puntos_semifinal: puntuacionJugador });
      }

      res.status(200).send('Puntos_semifinal de jugadores actualizados exitosamente');
    } catch (error) {
