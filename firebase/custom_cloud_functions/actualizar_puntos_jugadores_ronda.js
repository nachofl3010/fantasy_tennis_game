...
exports.actualizarPuntosJugadoresRonda = functions
  .runWith({
    memory: '128MB'
    ...
    try {
      ...
      for (const playerDoc of playersSnapshot.docs) {
        ...
        await playerRef.update({ puntos_r128: puntuacionJugador });
      }

      res.status(200).send('Puntos_r128 de jugadores actualizados exitosamente');
    } catch (error) {
