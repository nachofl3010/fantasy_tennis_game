...
exports.actualizarPuntosJugadoresOctavos = functions
  .runWith({
    memory: '128MB'
    ...
    try {
      ...
      for (const playerDoc of playersSnapshot.docs) {
        ...
        await playerRef.update({ puntos_octavos: puntuacionJugador });
      }

      res.status(200).send('Puntos_octavos de jugadores actualizados exitosamente');
    } catch (error) {
