        ...
        body: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: StreamBuilder<List<GanadoresPasadosRecord>>(
                stream: queryGanadoresPasadosRecord(),
                builder: (context, snapshot) {
                  ...
                  List<GanadoresPasadosRecord>
                      listViewGanadoresPasadosRecordList = snapshot.data!;
                  if (listViewGanadoresPasadosRecordList.isEmpty) {
                    return Center(
                      child: Image.asset(
                        'assets/images/logo_solo_letras.png',
                        width: 200.0,
                  ...
                  return ListView.builder(
                    ...
                    itemCount: listViewGanadoresPasadosRecordList.length,
                    itemBuilder: (context, listViewIndex) {
                      final listViewGanadoresPasadosRecord =
                          listViewGanadoresPasadosRecordList[listViewIndex];
                      return Padding(
                        padding: EdgeInsetsDirectional.fromSTEB(
                            16.0, 12.0, 12.0, 12.0),
                        child: StreamBuilder<UsersRecord>(
                          stream: UsersRecord.getDocument(
                              listViewGanadoresPasadosRecord.userRef!),
                          builder: (context, snapshot) {
                            // Customize what your widget looks like when it's loading.
                            if (!snapshot.hasData) {
                              return Center(
                                        ...
                                        Padding(
                                          padding:
                                              EdgeInsetsDirectional.fromSTEB(
                                                  0.0, 0.0, 0.0, 5.0),
                                          child: Text(
                                            listViewGanadoresPasadosRecord
                                                .torneo,
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium,
                                          ),
            ...
            Expanded(
              child: Padding(
                padding: EdgeInsetsDirectional.fromSTEB(0.0, 6.0, 0.0, 44.0),
                child: StreamBuilder<List<EquiposRecord>>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    List<EquiposRecord> listViewEquiposRecordList =
                        snapshot.data!;
                    return ListView.builder(
                      padding: EdgeInsets.zero,
                      primary: false,
                      scrollDirection: Axis.vertical,
                      itemCount: listViewEquiposRecordList.length,
                      itemBuilder: (context, listViewIndex) {
                        final listViewEquiposRecord =
                            listViewEquiposRecordList[listViewIndex];
                        return Padding(
                          padding: EdgeInsetsDirectional.fromSTEB(
                              16.0, 4.0, 16.0, 8.0),
                          child: StreamBuilder<UsersRecord>(
                            stream: UsersRecord.getDocument(
                                listViewEquiposRecord.userRef!),
                            builder: (context, snapshot) {
                              // Customize what your widget looks like when it's loading.
                              if (!snapshot.hasData) {
                                return Center(
                                ...
                                child: Padding(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        listViewEquiposRecord.puntosTorneo
                                            .toString(),
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
